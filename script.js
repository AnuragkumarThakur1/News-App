...
function fillDataInCard(cardClone, article) {
  const imgElement = cardClone.querySelector("#news-img");
  const titleElement = cardClone.querySelector("#news-title");
  const sourceElement = cardClone.querySelector("#news-source");
  const descElement = cardClone.querySelector("#news-desc");

  imgElement.src = article.urlToImage || "https://via.placeholder.com/400x200";
